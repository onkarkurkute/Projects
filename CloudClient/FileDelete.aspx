<%@ Page Language="C#" MasterPageFile="~/Default1.master" AutoEventWireup="true" CodeFile="FileDelete.aspx.cs" Inherits="FileDownload" Title="File Download Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Red" Style="z-index: 100;
        left: 929px; position: absolute; top: 290px" Text="Enter ID Of File To Delete" Width="242px"></asp:Label>
    &nbsp;
